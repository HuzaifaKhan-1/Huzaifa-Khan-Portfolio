...
const projectData = {
    codeheaven: {
        ...
        problem:
            "Create an interactive programming learning platform that provides real-time code editing, compilation, and step-by-step tutorials for multiple programming languages.",
        implementation: [
    ...
    "heart-disease": {
        ...
        accuracy: "94.2%",
        precision: "93.7%",
        images: ["assets/achievements/Heartdisease.mp4"],
        problem:
            "Develop a machine learning model to predict heart disease risk using patient medical data, helping doctors make informed decisions for early intervention.",
        implementation: [
        ...
        githubUrl:
            "https://github.com/HuzaifaKhan-1/Heart-Disease-Prediction-WebApp",
    },
    "ai-fitness": {
        ...
        problem:
            "Create an AI-powered fitness tracking application that accurately predicts calories burned based on user activities, biometric data, and exercise patterns.",
        implementation: [
    ...
    tripgenie: {
        ...
        problem:
            "Design an AI-powered travel itinerary planner that creates personalized travel recommendations based on user preferences, budget, and travel history.",
        implementation: [
    ...
    "pomegranate-disease": {
        ...
        problem:
            "Develop a computer vision system to detect diseases in pomegranate plants using image analysis, helping farmers identify and treat plant diseases early.",
        implementation: [
        ...
        githubUrl:
            "https://github.com/huzaifakamaalkhan/pomegranate-disease-detection",
    },
    "grapes-disease": {
        ...
        images: ["assets/projects/grapes1.jpg", "assets/projects/grapes2.jpg"],
        problem:
            "Create an advanced machine learning system for predicting grape diseases using CNN and Linear Discriminant Analysis for precise agricultural diagnostics.",
        implementation: [
        ...
        githubUrl:
            "https://github.com/huzaifakamaalkhan/grapes-disease-prediction",
    },
    "college-chatbot": {
        ...
        problem:
            "Build an intelligent chatbot using IBM WatsonX to handle college admission queries, providing instant and accurate responses to prospective students.",
        implementation: [
    ...
    "quantum-circuit": {
        ...
        status: "Completed",
        accuracy: "99.5%",
        qubits: "8-qubit simulation",
        images: [
            "assets/projects/quantum1.jpg",
            "assets/projects/quantum2.jpg",
        ],
        problem:
            "Create an interactive quantum computing platform using Qiskit to design, simulate, and visualize quantum circuits for educational and research purposes.",
        implementation: [
            "Built interactive quantum circuit designer with drag-and-drop interface",
            "Integrated Qiskit framework for quantum circuit simulation",
            "Developed real-time quantum state visualization and measurement",
            "Created library of pre-built quantum algorithms (Shor's, Grover's, etc.)",
            "Implemented quantum noise simulation for realistic quantum computing",
            "Added educational tutorials for quantum computing concepts",
            "Built quantum circuit optimization and error correction features",
        ],
        impact: "Created comprehensive quantum computing educational platform with 99.5% simulation accuracy, helping users understand quantum algorithms and principles.",
        technologies: [
            "Qiskit",
            "Python",
            "Quantum Computing",
        ...
        metrics: {
            simulationAccuracy: 99.5,
            quantumGates: 95,
            educationalValue: 92,
            performanceOptimization: 88,
        },
        githubUrl:
            "https://github.com/huzaifakamaalkhan/quantum-circuit-playground",
    },
};
...
const achievementData = {
    "faculty-induction": {
        ...
        problem:
            "Participate in comprehensive faculty induction program to understand modern teaching methodologies and educational excellence standards in computer engineering education.",
        implementation: [
    ...
    "kpit-sparkle": {
        ...
        problem:
            "Developed a VANET-based AI security system to detect and block Interest Flooding Attacks (IFA) and other malicious activities in Vehicular Named Data Networking (VNDN) for Smart Cars.",
        implementation: [
    ...
    "teaching-excellence": {
        ...
        images: ["assets/achievements/codecraft_hackathon.jpg"],
        problem:
            "Developed a hybrid deep learning model for classifying pomegranate fruit diseases to assist farmers in early detection and crop protection.",
        implementation: [
    ...
    "academic-presentation": {
        ...
        images: ["assets/achievements/achievement4.jpg"],
        problem:
            "Present cutting-edge research findings in artificial intelligence and machine learning applications to academic and industry audience.",
        implementation: [
    ...
    "isro-hackathon": {
        ...
        category: "Hackathon Achievement",
        images: ["assets/achievements/isro1.png"],
        problem:
            "Built a wildfire simulation and prediction system to help in early detection, monitoring, and disaster management using multi-modal space and ground data.",
        implementation: [
    ...
    "tech-innovation": {
        ...
        images: ["assets/achievements/achievement5.jpg"],
        problem:
            "Lead technological innovation initiatives and develop cutting-edge solutions for industry challenges in AI and software development.",
        implementation: [
    ...
    "kpit-team": {
        ...
        problem:
            "Collaborate effectively within Team Vanguardians to develop innovative mobility solutions and achieve collective success in national competition.",
        implementation: [
    ...
    "kpit-recognition": {
        ...
        images: ["assets/achievements/achievement7.jpg"],
        problem:
            "Demonstrate individual technical excellence and innovation capabilities in competitive environment while contributing to team success.",
        implementation: [
    ...
    "mobility-innovation": {
        ...
        images: ["assets/achievements/achievement8.jpg"],
        problem:
            "Develop next-generation transportation solutions that address current mobility challenges including traffic congestion, safety, and environmental sustainability.",
        implementation: [
    ...
    "executive-interaction": {
        ...
        images: ["assets/achievements/achievement9.jpg"],
        problem:
            "Engage with industry leaders to understand market needs, present innovative solutions, and gain insights into future technology trends.",
        implementation: [
    ...
    "kpit-campus": {
        ...
        images: ["assets/achievements/achievement10.jpg"],
        problem:
            "Experience world-class innovation environment and collaborate with industry professionals to develop cutting-edge technology solutions.",
        implementation: [
    ...
    "codecircuit-outlier": {
        ...
        category: "Hackathon Achievement",
        images: ["assets/achievements/codecircuit1.png"],
        problem:
            "Developed TripGenie – an AI-powered Travel Planner Web App, as part of CodeCircuit Hackathon by Outlier.ai.",
        implementation: [
...
function initializeAchievementModal() {
    ...
    const timelineItems = document.querySelectorAll(
        ".timeline-item[data-achievement]",
    );
...
function openAchievementModal(achievementId) {
    ...
    const implementationContainer = document.getElementById(
        "modalImplementation",
    );
    ...
    techStackContainer.innerHTML = data.technologies
...
function initializeProjectModal() {
    ...
    projectCards.forEach((card, index) => {
        ...
        // Ensure all cards have proper data-project attributes
    ...
    function closeProjectModal() {
        ...
        if (mediaContainer) {
            ...
            // Reset to default image element
...
function openProjectModal(projectId) {
    ...
    // Set main metrics
    document.getElementById("projectModalAccuracy").textContent =
        data.accuracy || "N/A";

    // Set main image or video
    const modalMainImage = document.getElementById("projectModalMainImage");
    const mediaContainer = modalMainImage.parentNode;
    ...
    let thumbnailContainer = document.getElementById("projectModalThumbnails");
    if (!thumbnailContainer) {
        thumbnailContainer = document.createElement("div");
        thumbnailContainer.id = "projectModalThumbnails";
        thumbnailContainer.className = "modal-thumbnails";
        mediaContainer.parentNode.appendChild(thumbnailContainer);
    }
    thumbnailContainer.innerHTML = "";
    ...
    if (data.images && data.images.length > 0) {
        ...
        if (isVideo) {
            ...
            videoElement.id = "projectModalMainImage";
            ...
            videoElement.onerror = function () {
                this.outerHTML =
                    '<div class="modal-media-error"><i class="fas fa-video-slash"></i> Video Unavailable</div>';
            };
        ...
        // Create thumbnails for multiple images/videos
        if (data.images.length > 1) {
            data.images.forEach((imagePath, index) => {
                const thumbnail = document.createElement("div");
                thumbnail.className = `modal-thumbnail ${index === 0 ? "active" : ""}`;

                const isThumbVideo = imagePath.toLowerCase().endsWith(".mp4");
                if (isThumbVideo) {
                    thumbnail.innerHTML = `
                        <video muted>
                            <source src="static/${imagePath}" type="video/mp4">
                        </video>
                ...
                thumbnail.addEventListener("click", () => {
                    ...
                    const mainMediaContainer =
                        document.querySelector(".modal-media-container") ||
                        mediaContainer;
                    const currentMedia =
                        mainMediaContainer.querySelector("img, video");
                    if (currentMedia) {
                        currentMedia.remove();
                    }
                    ...
                    if (isThumbVideo) {
                        ...
                        newVideo.id = "projectModalMainImage";
                        newVideo.src = `static/${imagePath}`;
                        ...
                        newImg.id = "projectModalMainImage";
                        ...
                        mainMediaContainer.appendChild(newImg);
                    }
        ...
        fallbackDiv.className = "modal-media-error";
        fallbackDiv.innerHTML =
            '<i class="fas fa-image"></i> No Media Available';
        mediaContainer.appendChild(fallbackDiv);
    }

    // Create implementation list
    const implementationContainer = document.getElementById(
        "projectModalImplementation",
    );
    if (Array.isArray(data.implementation)) {
        implementationContainer.innerHTML =
            "<ul>" +
...
const certificateData = {
    "google-ai-educators": {
        ...
        description:
            "Comprehensive certification covering the fundamentals and applications of generative AI in educational settings. This program focused on ethical AI implementation, prompt engineering, and integrating AI tools into curriculum design.",
        skills: [
            "Generative AI",
            "Educational Technology",
            "Prompt Engineering",
        ...
        certificateImage: "assets/certificates/certificate2-generativeAi.png",
    },
    "ibm-enterprise-ai": {
        ...
        description:
            "Advanced certification in enterprise-level AI solutions, covering Watson AI platform, machine learning deployment, and enterprise AI strategy. Focused on scalable AI implementations for business solutions.",
        skills: [
            "IBM Watson",
            "Enterprise AI",
            "ML Deployment",
        ...
        certificateImage: "assets/certificates/ibm-enterprise-ai.png",
    },
    "adverk-ai": {
        ...
        description:
            "Comprehensive AI certification covering machine learning algorithms, deep learning frameworks, and practical AI implementation. Gained hands-on experience with real-world AI projects and industry best practices.",
        skills: [
            "Machine Learning",
            "Deep Learning",
            "Neural Networks",
        ...
        certificateImage: "assets/certificates/adverk-course.png",
    },
    "aws-python-ai": {
        ...
        description:
            "Specialized certification in Python programming for AI applications on AWS cloud platform. Covered serverless AI, SageMaker, and deploying ML models at scale using AWS services.",
        skills: [
            "Python Programming",
            "AWS SageMaker",
            "Cloud AI",
        ...
        verificationUrl: "https://cert.devtown.in/verify/Z28gxRa",
        certificateImage: "assets/certificates/aws-ai.png",
    },
    "tata-crucible": {
        ...
        credentialId: "EF48640862EE",
        description:
            "Earned a HackerRank SQL (Basic) Certificate, demonstrating proficiency in writing simple queries, handling relationships, and performing aggregations. This certification highlights my skills in SQL and validates my ability to handle fundamental database operations, which are essential for efficient data management.",
        skills: [
            "SQL Queries",
            "Database",
            "MySQL"
        ],
        verificationUrl: "https://www.hackerrank.com/certificates/ef48640862ee",
        certificateImage: "assets/certificates/sql-hackerrank.png",
    },
    "flipkart-grid": {
        ...
        type: "Course Certificate",
        description:
            "Successfully Completed the Machine Learning Course on Udemy!",
            skills: [
            "ML Algorithms",
            "Data preprocessing",
            "Data Visualisation",
        ...
        verificationUrl: "",
        certificateImage: "assets/certificates/udemy-ml.png",
    },
    "google-genai-studio": {
        ...
        credentialId: "8130418",
        description:
            "Advanced certification in Google's GenAI Studio platform, focusing on building and deploying generative AI applications. Mastered prompt engineering, model fine-tuning, and API integration.",
        skills: [
            "GenAI Studio",
            "Model Fine-tuning",
            "API Integration",
        ...
        certificateImage: "assets/certificates/google-cloud.png",
    },
    "kpit-innovation": {
        title: "KPIT Sparkle Certificate",
        issuer: "KPIT Technologies, Pune",
        date: "March 2025",
        type: "Top 6 Finalist",
        description:
            "Recognition certificate for achieving Top 6 finalist position in KPIT Sparkle 2025 innovation challenge. Demonstrated exceptional innovation in autonomous vehicle technology and mobility solutions.",
        skills: [
            "Top 6 Finalists Nationwide",
            "Innovation",
            "Autonomous Systems",
            "Mobility Solutions",
            "Team Leadership",
        ...
        certificateImage: "assets/certificates/Kpit Certificate.jpg",
    },
    "ivm-quantum": {
        title: "Basics of Quantum Information Badge",
        issuer: "IBM",
        date: "Aug 5, 2025",
        type: "Digital Badge",
        description:
            "Comprehensive certification covering fundamental concepts of quantum information theory, quantum mechanics principles, and quantum computing applications. Focused on quantum gates, entanglement, and quantum algorithms.",
        skills: [
...
function openCertificateModal(certificateId) {
    ...
    document.getElementById("certificateModalCredential").textContent =
        data.credentialId;
